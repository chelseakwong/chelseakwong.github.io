...
library.GenerativePolygonArt = {
    ...
    video: "",
    caption: "This is a polygon art generator bot that posts to Twitter every hour. This bot computationally creates a new piece of polygon art, and automates this process for every hour such that it posts to Twtiter a new piece of polygon art every hour. The bot is written in Processing and Node.js, and it is hosted on an Ubuntu server provided by Digital Ocean. I was pleasantly surprised by the visual effects that emerged from simple programatic controls such as shading and camera angle.",
